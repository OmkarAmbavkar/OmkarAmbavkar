...
<sub>`N8n` `Power Automate` `Azure OpenAI` `PowerBi` `LLM` `Api`</sub>
...
**Technical Intern** — Siemens Limited &nbsp;·&nbsp; <sub>Mar 2026 — Present</sub>
...
<sub>`Python` `React` `Azure OpenAI` `n8n` `OCR`</sub>
...
<br/>
<sub>`Node.js` `Puppeteer` `YouTube API` `JavaScript`</sub>
...
<img src="https://skillicons.dev/icons?i=py,cpp,java,js,html,css,react,mongodb,git,azure&theme=dark" />

<sub>Python · C++ · Java · JavaScript &nbsp;—&nbsp; HTML · CSS · React · SQL · MongoDB &nbsp;—&nbsp; n8n · Power Automate · Git · Power BI · Tableau · Excel &nbsp;—&nbsp; Azure OpenAI · Azure AI Document Intelligence · Azure Blob Storage</sub>
